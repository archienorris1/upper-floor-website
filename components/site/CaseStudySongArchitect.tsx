          ...
          <div className="text-white">
            ...
            <ReadMore className="mt-6">
              <p className="text-base leading-relaxed text-white/80">
                ...
                passing 400,000 views on its own. Inside twelve months we became the leading voice
                in the niche and built a community of 10,000 people, and our work helped an artist
                reach over 10 million streams.
              </p>
              <img
                src="/media/sa-ig-stats.png"
                alt="Song Architect Instagram views analytics"
                className="mt-6 w-full max-w-[280px] rounded-2xl object-contain shadow-2xl ring-1 ring-white/10"
              />
            </ReadMore>
          </div>
        </div>
