...
export const metadata: Metadata = {
  title: 'Work With Us',
  description:
    'Upper Floor is a content agency for ecom brands. Human creative direction, AI-accelerated production, no slop. Book a free call and see if your brand qualifies for free content.',
  alternates: { canonical: '/workwithus' },
  robots: { index: false, follow: true },
  openGraph: {
    title: 'Work With Upper Floor',
    description:
      'UGC ads and organic content for ecom brands doing real numbers. Book a free call and see if you qualify for free content.',
    type: 'website',
      ...
      <section className="relative flex min-h-[92svh] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center px-5 pb-20 pt-32 text-center md:pb-28 md:pt-40">
          ...
          <p className="hero-load hero-load-3 mx-auto mt-7 max-w-xl text-base leading-relaxed text-white/80 md:text-lg">
            Upper Floor is the content agency behind $700k months for ecom brands. Real creative
            direction, AI where it earns its place, zero slop. Book a free call and see if your
            brand qualifies for a piece of content on us.
          </p>
      ...
      <section className="py-10 md:py-16">
        <div className="reveal-on-scroll mx-auto mb-8 max-w-6xl px-5 text-center md:mb-12 md:px-8">
          ...
          <p className="mx-auto mt-4 max-w-lg text-base text-white/70 md:text-lg">
            UGC ads and organic for ecom brands. Tap a clip for sound.
          </p>
        </div>
        <WorkGrid />
      </section>
